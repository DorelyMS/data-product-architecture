...
2. [Resumen](https://github.com/DorelyMS/data-product-architecture#2-summary-de-los-datos-para-eda-actualizado-al-15-de-enero-2021)
...
5. [Pipeline](https://github.com/DorelyMS/data-product-architecture#5-overview-pipeline)
...
## 2. Resumen EDA (actualizado al 15 de enero 2021)
...
* Las variables originales, así como su descripción (tomada directamente de la [referencia oficial](http://bit.ly/tS9IE8) sugerida para su consulta dentro del portal [Chicago Food Inspections](https://data.cityofchicago.org/Health-Human-Services/Food-Inspections/4ijn-s7e5)) son:
...
#### Ejemplos de Ejecución Pipeline
